...
function AboutEdu({ from, to, label }) {
  ...
  return (
    <div className="text-center items-center"> 
      <p className={`text-blue-900 mx-auto text-[35px] lg:text-[70px] font-bold ${reachedTarget ? 'transition-class' : ''}`} ref={nodeRef} />
      <p className="text-blue-900 mx-auto mt-0 lg:mt-[-20px] mb-2 text-[17px] lg:text-[30px] font-semibold">{label}</p>
    </div>
  );
}
