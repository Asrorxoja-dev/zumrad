  ...
  return (
    <footer className="bg-blue-900 mt-20 text-white ">
      <div className="footer-container py-5 lg:py-10 grid grid-cols-1 lg:grid-cols-3 px-5 lg:px-20 items-center">
        <div className="footer-left-part mx-auto lg:mx-0 grid items-center gap-4 justify-between">
          <img src={zumrad} className="w-52 ml-3 cursor-pointer mb-2 lg:ml-0" />
          <ul className="footer-icons flex gap-12 ml-3 lg:ml-0 px-6">
            <li>
              <a
        ...
        <div className="footer-right-part mt-10 lg:mt-10 flex gap-10 lg:gap-20 mx-auto lg:mx-0">
        ...
        <div className="footer-map flex">
          <iframe
          className="w-full mx-auto h-full max-w-xs lg:max-w-xl md:max-w-xl"
