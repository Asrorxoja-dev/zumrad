...
function WeOffers() {
  return (
    <div id='offer' className='offer  mt-20  mb-10'>
    <h2 className='text-2xl lg:text-4xl text-blue-900 font-bold mt-10 ml-4 lg:ml-0 mb-10'>Bizning takliflar</h2>
        <div className='grid grid-cols-1 lg:grid-cols-2 '>
            <figure>
                <img className='w-full px-3 md-h-auto rounded-b-md  ' src={offer} alt="course" />
            </figure>
        <div className='offers ml-5 lg:ml-10 text-xl lg:text-4xl font-bold '>
